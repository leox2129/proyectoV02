...
CREATE TABLE `patologia` (
  ...
  `gravedad` int NOT NULL DEFAULT '60',
...
INSERT INTO `patologia` VALUES (1,25,'Gripe'),(2,45,'Coronavirus'),(3,75,'Estafilococus'),(4,30,'Resfrio'),(5,80,'Pulmonia'),(6,100,'Ataque cardiaco'),(7,12,'patologi'),(8,50,'patologia 8'),(9,60,'tartamudo');
